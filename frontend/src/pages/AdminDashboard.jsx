...
import { UserCircle, Users, UserPlus, FilePlus2, Bell, LogOut, FileSpreadsheet, PanelRightOpen, PanelLeftOpen, Pencil, Trash2 } from 'lucide-react';
      ...
      case 'users':
        return (
          <div className="space-y-4">
            ...
            {!loading && !error && (
              <div className="bg-white rounded-lg shadow overflow-x-auto w-full"> {/* Tableau occupe toute la largeur */}
