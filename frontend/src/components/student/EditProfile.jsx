...
const EditProfile = () => {
  ...
  const handlePersonalSubmit = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${API_URL}/api/users/updatePersonal/${userId}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
  ...
  const executePasswordUpdate = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${API_URL}/api/users/updatePassword/${userId}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-6 max-w-lg mx-auto">
      ...
      <div className="flex mb-6 justify-center items-center">
        <button
          className={`py-2 px-4 font-medium mr-2 ${
            activeTab === "personal"
        ...
        <form onSubmit={preparePersonalSubmit} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setPersonalData({ ...personalData, department: e.target.value })
              }
              className="border bg-white border-gray-300 p-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#a1432b] w-full"
            />
          </div>
          ...
          <button
            ...
            className={`px-4 py-2 rounded-lg w-full ${
              formLoading || !isPersonalFormValid()
