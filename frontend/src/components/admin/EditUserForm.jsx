      ...
      <div className="space-y-6 max-w-lg mx-auto">
        <div className="flex items-center gap-4">
          ...
          <h2 className="text-xl text-center font-semibold mb-4">
            Modifier les informations de {originalName.first_name}{" "}
            {originalName.surname}
          </h2>
        </div>
        {error && (
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="flex flex-col sm:flex-row sm:space-x-4 space-y-6 sm:space-y-0">
            <div className="flex-1">
              ...
              <input
                type="text"
                placeholder="Modifiez le prénom"
          ...
          <div>
            ...
            <input
              type="email"
              placeholder="Modifiez l'adresse mail"
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                required
                className="border bg-white border-gray-300 p-2 rounded-lg w-full pr-10 focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
              <button
                type="button"
                onClick={() => setShowAdminPassword(!showAdminPassword)}
                className="absolute inset-y-0 right-1 pr-3 flex items-center text-sm bg-transparent border-none"
              >
                {showAdminPassword ? (
          ...
          <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
            <div className="bg-white p-6 rounded-lg shadow-lg">
              <p className="text-lg mb-4">
                Êtes-vous sûr de vouloir effectuer ces modifications ?
              </p>
