...
const UserManagement = () => {
  ...
  const baseUrl = `${API_URL}/api/users/`; // URL de base
  const fetchUsers = async () => {
    ...
    if (searchType && searchValue) {
      if (searchType === "email") {
        url = `${API_URL}/api/users/emailsearch/${searchValue}`;
      } else if (searchType === "role") {
        url = `${API_URL}/api/users/role/${searchValue}`;
      } else if (searchType === "course") {
        url = `${API_URL}/api/users/course/${searchValue}`;
      }
    }
