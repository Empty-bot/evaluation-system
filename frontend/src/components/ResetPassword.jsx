      ...
      <div className="bg-white p-8 md:p-12 rounded-lg shadow-xl w-full max-w-md lg:max-w-xl min-h-[500px] lg:min-h-[600px] flex flex-col items-center">
        ...
        <form onSubmit={handleSubmit} className="w-full space-y-4 md:space-y-6">
          ...
          <div className="relative">
            ...
            <div className="h-5">
              <p
                className={`text-xs transition-opacity duration-200 ${confirmPassword && !passwordsMatch ? "text-red-500 opacity-100" : "opacity-0"}`}
              >
                Les mots de passe ne correspondent pas
              </p>
              <p
                className={`text-xs transition-opacity duration-200 ${confirmPassword && passwordsMatch ? "text-green-500 opacity-100" : "opacity-0"}`}
              >
